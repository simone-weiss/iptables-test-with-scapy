...
ip6tables -t nat -A OUTPUT -o eth0.42 -p tcp -d 2001:db8::2 --dport 60000 -j REDIRECT --to-ports 60001
ip6tables -t mangle -A POSTROUTING -p udp -j MARK --set-mark 0x11110000/0xffffffff
